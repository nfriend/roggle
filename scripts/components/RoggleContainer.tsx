module Roggle {
	...
	export class RoggleContainer extends React.Component<RoggleContainerProps, RoggleContainerState> {
		...
		render() {
			return (
				<div className="container">
					...
					<br />
					<br />
					<button className="btn btn-lg btn-default" onClick={this.shakeItUp}>Shake it up!</button>
				</div>
			);
		}
	}
